...
import com.seasluggames.serenitypixeldungeon.windows.WndInfoTalent;
...
public class TalentButton extends Button {
	...
	protected void onClick() {
		...
		if (upgradeEnabled
			...
			SerenityPixelDungeon.scene().addToFront(new WndInfoTalent(talent, pointsInTalent, new Callback() {
				@Override
				public void call() {
					upgradeTalent();
				}
			...
			SerenityPixelDungeon.scene().addToFront(new WndInfoTalent(talent, pointsInTalent, null));
		}
	}
