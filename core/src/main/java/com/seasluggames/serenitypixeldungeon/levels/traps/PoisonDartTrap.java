...
import com.seasluggames.serenitypixeldungeon.items.weapon.missiles.darts.PoisonDart;
			...
			if (Dungeon.level.heroFOV[pos] || Dungeon.level.heroFOV[target.pos]) {
				Actor.add(new Actor() {
					...
					protected boolean act() {
						...
						((MissileSprite) SerenityPixelDungeon.scene().recycle(MissileSprite.class)).
