...
import com.seasluggames.serenitypixeldungeon.android.actors.blobs.Alchemy;
import com.seasluggames.serenitypixeldungeon.android.actors.buffs.AdrenalineSurge;
import com.seasluggames.serenitypixeldungeon.android.actors.buffs.Amok;
import com.seasluggames.serenitypixeldungeon.android.actors.buffs.Awareness;
...
import com.seasluggames.serenitypixeldungeon.android.actors.buffs.Foresight;
import com.seasluggames.serenitypixeldungeon.android.actors.buffs.Fury;
...
import com.seasluggames.serenitypixeldungeon.android.actors.buffs.MindVision;
import com.seasluggames.serenitypixeldungeon.android.actors.buffs.Momentum;
import com.seasluggames.serenitypixeldungeon.android.actors.buffs.Paralysis;
import com.seasluggames.serenitypixeldungeon.android.actors.buffs.Regeneration;
import com.seasluggames.serenitypixeldungeon.android.actors.buffs.SnipersMark;
...
import com.seasluggames.serenitypixeldungeon.android.items.Amulet;
...
import com.seasluggames.serenitypixeldungeon.android.items.Heap.Type;
...
import com.seasluggames.serenitypixeldungeon.android.items.armor.glyphs.Brimstone;
import com.seasluggames.serenitypixeldungeon.android.items.armor.glyphs.Viscosity;
...
import com.seasluggames.serenitypixeldungeon.android.items.keys.CrystalKey;
import com.seasluggames.serenitypixeldungeon.android.items.keys.GoldenKey;
import com.seasluggames.serenitypixeldungeon.android.items.keys.IronKey;
import com.seasluggames.serenitypixeldungeon.android.items.keys.Key;
import com.seasluggames.serenitypixeldungeon.android.items.keys.SkeletonKey;
...
import com.seasluggames.serenitypixeldungeon.android.items.weapon.enchantments.Blocking;
...
import com.seasluggames.serenitypixeldungeon.android.scenes.SurfaceScene;
...
import com.seasluggames.serenitypixeldungeon.android.ui.AttackIndicator;
...
import com.seasluggames.serenitypixeldungeon.android.ui.StatusPane;
import com.seasluggames.serenitypixeldungeon.android.utils.GLog;
import com.seasluggames.serenitypixeldungeon.android.windows.WndHero;
import com.seasluggames.serenitypixeldungeon.android.windows.WndMessage;
import com.seasluggames.serenitypixeldungeon.android.windows.WndResurrect;
...
public class Hero extends Char {
	...
	private boolean actAlchemy( HeroAction.Alchemy action ) {
		...
		if (Dungeon.level.distance(dst, pos) <= 1) {
			...
			SPDMain.switchScene(AlchemyScene.class);
			return false;
