...
public class Hunger extends Buff implements Hero.Doom {
    ...
    public static float HUNGRY = 400f; //300 Shattered 450 Serenity
    public static float STARVING = 550f; //450 Shattered 600 Serenity
    ...
    public boolean act() {
        ...
        if (target.isAlive() && target instanceof Hero) {
            ...
            if (isStarving()) {
                ...
                if (Dungeon.hero.hasTalent(Talent.MANTRA)) {
                    switch (Dungeon.hero.pointsInTalent(Talent.MANTRA)) {
                        case 1:
                            newLevel = level + (STEP - 1f);
                            break;
                        case 2:
                            newLevel = level + (STEP - 3f);
                            break;
                    }
                } else {
                    newLevel = level + STEP;
