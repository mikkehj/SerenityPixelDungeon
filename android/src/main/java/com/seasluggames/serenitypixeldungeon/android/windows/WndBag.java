...
public class WndBag extends com.seasluggames.serenitypixeldungeon.android.windows.WndTabbed {
	...
	private class ItemButton extends ItemSlot {
		...
		protected void onClick() {
			if (lastBag != item && !lastBag.contains(item) && !item.isEquipped(Dungeon.hero)){
				...
				Game.scene().addToFront(new com.seasluggames.serenitypixeldungeon.android.windows.WndUseItem( WndBag.this, item ) );
		...
		protected boolean onLongClick() {
			if (listener == null && item.defaultAction != null) {
				...
				Game.scene().addToFront(new com.seasluggames.serenitypixeldungeon.android.windows.WndInfoItem(item));
				return true;
			} else {
				return false;
			}
