...
import com.seasluggames.serenitypixeldungeon.android.windows.WndChallenges;
...
public class HeroSelectScene extends PixelScene {
	...
	public void create() {
		...
		infoButton = new IconButton(Icons.get(Icons.INFO)){
			...
			protected void onClick() {
				super.onClick();
				SPDMain.scene().addToFront(new WndHeroInfo(GamesInProgress.selectedClass));
			}
		};
	...
	private class HeroBtn extends StyledButton {
		...
		protected void onClick() {
			...
			if( !cl.isUnlocked() ){
				...
				SPDMain.scene().add(new WndHeroInfo(cl));
			} else {
				setSelectedHero(cl);
			}
		}
