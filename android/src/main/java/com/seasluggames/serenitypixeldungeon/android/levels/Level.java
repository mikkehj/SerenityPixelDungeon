...
import com.seasluggames.serenitypixeldungeon.android.actors.blobs.WellWater;
...
import com.seasluggames.serenitypixeldungeon.android.actors.buffs.MagicalSight;
import com.seasluggames.serenitypixeldungeon.android.actors.buffs.MindVision;
import com.seasluggames.serenitypixeldungeon.android.actors.buffs.Shadows;
...
import com.seasluggames.serenitypixeldungeon.android.actors.mobs.Bestiary;
import com.seasluggames.serenitypixeldungeon.android.actors.mobs.Mimic;
...
import com.seasluggames.serenitypixeldungeon.android.effects.particles.FlowParticle;
import com.seasluggames.serenitypixeldungeon.android.effects.particles.WindParticle;
...
import com.seasluggames.serenitypixeldungeon.android.items.Stylus;
import com.seasluggames.serenitypixeldungeon.android.items.Torch;
...
import com.seasluggames.serenitypixeldungeon.android.levels.features.Door;
import com.seasluggames.serenitypixeldungeon.android.levels.features.HighGrass;
...
import static com.seasluggames.serenitypixeldungeon.android.levels.Terrain.CHASM;
import static com.seasluggames.serenitypixeldungeon.android.levels.Terrain.WALL;
...
public abstract class Level implements Bundlable {
	...
	public void setSize(int w, int h){
		...
		map = new int[length];
		Arrays.fill( map, feeling == Level.Feeling.CHASM ? CHASM : WALL );
	...
	public Heap drop( Item item, int cell ) {
		...
		if (Dungeon.level != null && SPDMain.scene() instanceof GameScene) {
			pressCell( cell );
		}
