...
import com.seasluggames.serenitypixeldungeon.android.items.armor.LeatherArmor;
import com.seasluggames.serenitypixeldungeon.android.items.armor.MailArmor;
import com.seasluggames.serenitypixeldungeon.android.items.armor.PlateArmor;
import com.seasluggames.serenitypixeldungeon.android.items.armor.ScaleArmor;
...
import com.seasluggames.serenitypixeldungeon.android.items.artifacts.CapeOfThorns;
...
import com.seasluggames.serenitypixeldungeon.android.items.artifacts.EtherealChains;
import com.seasluggames.serenitypixeldungeon.android.items.artifacts.HornOfPlenty;
import com.seasluggames.serenitypixeldungeon.android.items.artifacts.LloydsBeacon;
import com.seasluggames.serenitypixeldungeon.android.items.artifacts.MasterThievesArmband;
import com.seasluggames.serenitypixeldungeon.android.items.artifacts.SandalsOfNature;
import com.seasluggames.serenitypixeldungeon.android.items.artifacts.TalismanOfForesight;
import com.seasluggames.serenitypixeldungeon.android.items.artifacts.TimekeepersHourglass;
import com.seasluggames.serenitypixeldungeon.android.items.artifacts.UnstableSpellbook;
...
import com.seasluggames.serenitypixeldungeon.android.items.rings.RingOfAccuracy;
import com.seasluggames.serenitypixeldungeon.android.items.rings.RingOfElements;
import com.seasluggames.serenitypixeldungeon.android.items.rings.RingOfEnergy;
import com.seasluggames.serenitypixeldungeon.android.items.rings.RingOfEvasion;
import com.seasluggames.serenitypixeldungeon.android.items.rings.RingOfForce;
import com.seasluggames.serenitypixeldungeon.android.items.rings.RingOfFuror;
import com.seasluggames.serenitypixeldungeon.android.items.rings.RingOfHaste;
import com.seasluggames.serenitypixeldungeon.android.items.rings.RingOfMight;
import com.seasluggames.serenitypixeldungeon.android.items.rings.RingOfSharpshooting;
import com.seasluggames.serenitypixeldungeon.android.items.rings.RingOfTenacity;
...
import com.seasluggames.serenitypixeldungeon.android.items.stones.StoneOfAffection;
import com.seasluggames.serenitypixeldungeon.android.items.stones.StoneOfAggression;
import com.seasluggames.serenitypixeldungeon.android.items.stones.StoneOfAugmentation;
import com.seasluggames.serenitypixeldungeon.android.items.stones.StoneOfBlast;
import com.seasluggames.serenitypixeldungeon.android.items.stones.StoneOfBlink;
import com.seasluggames.serenitypixeldungeon.android.items.stones.StoneOfClairvoyance;
import com.seasluggames.serenitypixeldungeon.android.items.stones.StoneOfDeepenedSleep;
import com.seasluggames.serenitypixeldungeon.android.items.stones.StoneOfDisarming;
import com.seasluggames.serenitypixeldungeon.android.items.stones.StoneOfEnchantment;
import com.seasluggames.serenitypixeldungeon.android.items.stones.StoneOfFlock;
import com.seasluggames.serenitypixeldungeon.android.items.stones.StoneOfIntuition;
import com.seasluggames.serenitypixeldungeon.android.items.stones.StoneOfShock;
...
import com.seasluggames.serenitypixeldungeon.android.items.wands.WandOfCorrosion;
import com.seasluggames.serenitypixeldungeon.android.items.wands.WandOfCorruption;
...
import com.seasluggames.serenitypixeldungeon.android.items.wands.WandOfRegrowth;
...
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.AssassinsBlade;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.BattleAxe;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Crossbow;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Dagger;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Dirk;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Flail;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Gauntlet;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Glaive;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Gloves;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Greataxe;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Greatshield;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Greatsword;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.HandAxe;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Longsword;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Mace;
...
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Quarterstaff;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.RoundShield;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.RunicBlade;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Sai;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Scimitar;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Shortsword;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Spear;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Sword;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.WarHammer;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.Whip;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.melee.WornShortsword;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.missiles.Bolas;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.missiles.FishingSpear;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.missiles.ForceCube;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.missiles.HeavyBoomerang;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.missiles.Javelin;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.missiles.Kunai;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.missiles.MissileWeapon;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.missiles.Shuriken;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.missiles.ThrowingClub;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.missiles.ThrowingHammer;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.missiles.ThrowingKnife;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.missiles.ThrowingSpear;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.missiles.ThrowingStone;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.missiles.Tomahawk;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.missiles.Trident;
import com.seasluggames.serenitypixeldungeon.android.plants.Blindweed;
import com.seasluggames.serenitypixeldungeon.android.plants.Dreamfoil;
import com.seasluggames.serenitypixeldungeon.android.plants.Earthroot;
import com.seasluggames.serenitypixeldungeon.android.plants.Fadeleaf;
import com.seasluggames.serenitypixeldungeon.android.plants.Firebloom;
import com.seasluggames.serenitypixeldungeon.android.plants.Icecap;
...
import com.seasluggames.serenitypixeldungeon.android.plants.Sorrowmoss;
import com.seasluggames.serenitypixeldungeon.android.plants.Starflower;
import com.seasluggames.serenitypixeldungeon.android.plants.Stormvine;
import com.seasluggames.serenitypixeldungeon.android.plants.Sungrass;
