...
package com.seasluggames.serenitypixeldungeon.ui;
...
import com.seasluggames.serenitypixeldungeon.items.Recipe;
import com.seasluggames.serenitypixeldungeon.items.bombs.Bomb;
import com.seasluggames.serenitypixeldungeon.items.food.Blandfruit;
import com.seasluggames.serenitypixeldungeon.items.food.Food;
import com.seasluggames.serenitypixeldungeon.items.food.MeatPie;
...
import com.seasluggames.serenitypixeldungeon.items.food.StewedMeat;
...
import com.seasluggames.serenitypixeldungeon.items.potions.brews.BlizzardBrew;
import com.seasluggames.serenitypixeldungeon.items.potions.brews.CausticBrew;
import com.seasluggames.serenitypixeldungeon.items.potions.brews.InfernalBrew;
import com.seasluggames.serenitypixeldungeon.items.potions.brews.ShockingBrew;
import com.seasluggames.serenitypixeldungeon.items.potions.elixirs.ElixirOfAquaticRejuvenation;
import com.seasluggames.serenitypixeldungeon.items.potions.elixirs.ElixirOfArcaneArmor;
import com.seasluggames.serenitypixeldungeon.items.potions.elixirs.ElixirOfDragonsBlood;
import com.seasluggames.serenitypixeldungeon.items.potions.elixirs.ElixirOfHoneyedHealing;
import com.seasluggames.serenitypixeldungeon.items.potions.elixirs.ElixirOfIcyTouch;
import com.seasluggames.serenitypixeldungeon.items.potions.elixirs.ElixirOfMight;
import com.seasluggames.serenitypixeldungeon.items.potions.elixirs.ElixirOfToxicEssence;
import com.seasluggames.serenitypixeldungeon.items.potions.exotic.ExoticPotion;
import com.seasluggames.serenitypixeldungeon.items.scrolls.Scroll;
import com.seasluggames.serenitypixeldungeon.items.scrolls.exotic.ExoticScroll;
import com.seasluggames.serenitypixeldungeon.items.spells.Alchemize;
import com.seasluggames.serenitypixeldungeon.items.spells.AquaBlast;
import com.seasluggames.serenitypixeldungeon.items.spells.ArcaneCatalyst;
import com.seasluggames.serenitypixeldungeon.items.spells.BeaconOfReturning;
import com.seasluggames.serenitypixeldungeon.items.spells.CurseInfusion;
import com.seasluggames.serenitypixeldungeon.items.spells.FeatherFall;
import com.seasluggames.serenitypixeldungeon.items.spells.MagicalInfusion;
import com.seasluggames.serenitypixeldungeon.items.spells.MagicalPorter;
import com.seasluggames.serenitypixeldungeon.items.spells.PhaseShift;
import com.seasluggames.serenitypixeldungeon.items.spells.ReclaimTrap;
import com.seasluggames.serenitypixeldungeon.items.spells.Recycle;
import com.seasluggames.serenitypixeldungeon.items.spells.WildEnergy;
...
public class QuickRecipe extends Component {
	...
	public QuickRecipe(Recipe r, ArrayList<Item> inputs, final Item output) {
		...
		for (final Item in : inputs) {
			...
			curr = new ItemSlot(in) {
				...
				protected void onClick() {
					SerenityPixelDungeon.scene().addToFront(new WndInfoItem(in));
				}
			};
		...
		if (hasInputs) {
			...
			if (!(SerenityPixelDungeon.scene() instanceof AlchemyScene)) {
				arrow.enable(false);
			}
		} else {
		...
		this.output = new ItemSlot(output){
			@Override
			protected void onClick() {
				SerenityPixelDungeon.scene().addToFront(new WndInfoItem(output));
			}
		};
		if (!hasInputs){
	...
	public class arrow extends IconButton {
		...
		protected void onClick() {
			...
			((AlchemyScene) SerenityPixelDungeon.scene()).populate(ingredients, Dungeon.hero.belongings);
		}
