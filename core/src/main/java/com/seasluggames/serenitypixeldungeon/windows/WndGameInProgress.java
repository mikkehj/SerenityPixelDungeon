...
import com.seasluggames.serenitypixeldungeon.scenes.StartScene;
	...
	public WndGameInProgress(final int slot){
		...
		Button debug = new Button(){
			...
			protected boolean onLongClick() {
				try {
					...
					SerenityPixelDungeon.scene().addToFront(new WndMessage("_Debug Info:_\n\n" +
		...
		PurpleButton cont = new PurpleButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				SerenityPixelDungeon.switchScene(InterlevelScene.class);
			}
		};
