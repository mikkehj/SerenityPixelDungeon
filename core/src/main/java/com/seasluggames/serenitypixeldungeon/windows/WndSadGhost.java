...
import com.seasluggames.serenitypixeldungeon.sprites.FetidRatSprite;
import com.seasluggames.serenitypixeldungeon.sprites.GnollTricksterSprite;
import com.seasluggames.serenitypixeldungeon.sprites.GreatCrabSprite;
		...
		public RewardButton( Item item ){
			...
			slot = new ItemSlot( item ){
				...
				protected void onClick() {
					SerenityPixelDungeon.scene().addToFront(new RewardWindow(item));
				}
			};
			add(slot);
		}
