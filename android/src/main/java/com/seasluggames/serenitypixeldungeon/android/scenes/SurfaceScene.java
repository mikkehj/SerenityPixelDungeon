...
import com.seasluggames.serenitypixeldungeon.android.sprites.EarthGuardianSprite;
import com.seasluggames.serenitypixeldungeon.android.sprites.GhostSprite;
import com.seasluggames.serenitypixeldungeon.android.sprites.RatSprite;
import com.seasluggames.serenitypixeldungeon.android.sprites.WardSprite;
...
public class SurfaceScene extends PixelScene {
	...
	public void create() {
		...
		PurpleButton gameOver = new PurpleButton( Messages.get(this, "exit") ) {
