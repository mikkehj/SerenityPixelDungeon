...
public class AboutScene extends PixelScene {
	...
	public void create() {
		...
		shpx.setRect(ssg.left(), ssg.bottom() + 8, colWidth, 0);
		...
		CreditsBlock gdx = new CreditsBlock(true,
				...
				null,
				Icons.LIBGDX.get(),
				"SerenityPD is powered by _libGDX_!",
		...
		CreditsBlock freesound = new CreditsBlock(true,
				...
				null,
				null,
				"Serenity Pixel Dungeon uses the following sound samples from _freesound.org_:\n\n" +
	...
	protected void onBackPressed() {
		SPDMain.switchScene(com.seasluggames.serenitypixeldungeon.android.scenes.TitleScene.class);
	}
	...
	private static class SSGBlock extends Component {
		...
		//many elements can be null, but body is assumed to have content.
		private SSGBlock(boolean large, int highlight, String title, Image avatar, String body, String linkText, String linkUrl){
			super();
