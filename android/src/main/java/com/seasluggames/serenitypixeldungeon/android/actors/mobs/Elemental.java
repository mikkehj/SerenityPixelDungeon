...
import com.seasluggames.serenitypixeldungeon.android.sprites.ElementalSprite;
...
public abstract class Elemental extends Mob {
	...
	public static class FireElemental extends Elemental {
		
		{
			...
			harmfulBuffs.add( com.seasluggames.serenitypixeldungeon.android.actors.buffs.Frost.class );
