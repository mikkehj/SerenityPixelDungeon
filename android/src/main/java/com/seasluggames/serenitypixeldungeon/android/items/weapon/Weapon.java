...
import com.seasluggames.serenitypixeldungeon.android.items.weapon.curses.Annoying;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.curses.Displacing;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.curses.Exhausting;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.curses.Fragile;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.curses.Friendly;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.curses.Polarized;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.curses.Sacrificial;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.curses.Wayward;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.enchantments.Blazing;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.enchantments.Blocking;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.enchantments.Blooming;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.enchantments.Chilling;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.enchantments.Corrupting;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.enchantments.Elastic;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.enchantments.Grim;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.enchantments.Kinetic;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.enchantments.Lucky;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.enchantments.Projecting;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.enchantments.Shocking;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.enchantments.Unstable;
import com.seasluggames.serenitypixeldungeon.android.items.weapon.enchantments.Vampiric;
