...
package com.seasluggames.serenitypixeldungeon.levels.painters;
...
import com.seasluggames.serenitypixeldungeon.levels.Patch;
		...
		for (Room n : r.connected.keySet()) {
			...
			if (door == null) {
				...
				if (doorSpots.isEmpty()){
					SerenityPixelDungeon.reportException(
