...
package com.seasluggames.serenitypixeldungeon.android.messages;
...
public enum Languages {
	...
	CHINESE("中文",         "zh", Status.UNREVIEWED,  new String[]{"Jinkeloid(zdx00793)", "endlesssolitude"}, new String[]{"931451545", "Fatir", "Fishbone", "HoofBumpBlurryface", "Lery", "Lyn_0401", "SerenityFlameBlast", "SpaceAnchor", "hmdzl001", "leo", "tempest102"}),
