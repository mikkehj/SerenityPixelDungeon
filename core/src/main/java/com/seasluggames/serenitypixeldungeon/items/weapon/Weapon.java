...
package com.seasluggames.serenitypixeldungeon.items.weapon;
...
import com.seasluggames.serenitypixeldungeon.items.weapon.curses.Annoying;
import com.seasluggames.serenitypixeldungeon.items.weapon.curses.Displacing;
import com.seasluggames.serenitypixeldungeon.items.weapon.curses.Exhausting;
import com.seasluggames.serenitypixeldungeon.items.weapon.curses.Fragile;
import com.seasluggames.serenitypixeldungeon.items.weapon.curses.Friendly;
import com.seasluggames.serenitypixeldungeon.items.weapon.curses.Polarized;
import com.seasluggames.serenitypixeldungeon.items.weapon.curses.Sacrificial;
import com.seasluggames.serenitypixeldungeon.items.weapon.curses.Wayward;
import com.seasluggames.serenitypixeldungeon.items.weapon.enchantments.Blazing;
import com.seasluggames.serenitypixeldungeon.items.weapon.enchantments.Blocking;
import com.seasluggames.serenitypixeldungeon.items.weapon.enchantments.Blooming;
import com.seasluggames.serenitypixeldungeon.items.weapon.enchantments.Chilling;
import com.seasluggames.serenitypixeldungeon.items.weapon.enchantments.Corrupting;
import com.seasluggames.serenitypixeldungeon.items.weapon.enchantments.Elastic;
import com.seasluggames.serenitypixeldungeon.items.weapon.enchantments.Grim;
import com.seasluggames.serenitypixeldungeon.items.weapon.enchantments.Kinetic;
import com.seasluggames.serenitypixeldungeon.items.weapon.enchantments.Lucky;
import com.seasluggames.serenitypixeldungeon.items.weapon.enchantments.Projecting;
import com.seasluggames.serenitypixeldungeon.items.weapon.enchantments.Shocking;
import com.seasluggames.serenitypixeldungeon.items.weapon.enchantments.Unstable;
import com.seasluggames.serenitypixeldungeon.items.weapon.enchantments.Vampiric;
