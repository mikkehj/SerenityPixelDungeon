...
import com.seasluggames.serenitypixeldungeon.android.effects.Surprise;
import com.seasluggames.serenitypixeldungeon.android.effects.Wound;
	...
	public void destroy() {
		...
		if (Dungeon.hero.isAlive()) {
			...
			if (alignment == Alignment.ENEMY) {
				...
				if (Dungeon.hero.hasTalent(Talent.DIVINE_TOUCH)){
					Dungeon.hero.sprite.showStatus(CharSprite.POSITIVE, Messages.get(this, "exp", exp + Dungeon.hero.pointsInTalent(Talent.DIVINE_TOUCH)));
				} else {
