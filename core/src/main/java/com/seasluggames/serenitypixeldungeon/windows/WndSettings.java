...
import com.seasluggames.serenitypixeldungeon.ui.CheckBox;
import com.seasluggames.serenitypixeldungeon.ui.Icons;
import com.seasluggames.serenitypixeldungeon.ui.OptionSlider;
...
public class WndSettings extends WndTabbed {
    ...
    public void hide() {
        ...
        SerenityPixelDungeon.seamlessResetScene(new Game.SceneChangeCallback() {
            @Override
            ...
            if (!DeviceCompat.isDesktop() && PixelScene.maxScreenZoom >= 2) {
                chkSaver = new CheckBox(Messages.get(this, "saver")) {
                    ...
                    protected void onClick() {
                        ...
                        if (checked()) {
                            checked(!checked());
                            SerenityPixelDungeon.scene().add(new WndOptions(
                ...
                optScale = new OptionSlider(Messages.get(this, "scale"),
                    ...
                    protected void onChange() {
                        if (getSelectedValue() != SPDSettings.scale()) {
                            ...
                            SerenityPixelDungeon.seamlessResetScene();
                        }
                    }
                };
        ...
        protected void createChildren() {
            ...
            if (DeviceCompat.hasHardKeyboard()) {
                ...
                btnKeyBindings = new PurpleButton(Messages.get(this, "key_bindings")) {
                    ...
                    protected void onClick() {
                        super.onClick();
                        SerenityPixelDungeon.scene().addToFront(new WndKeyBindings());
                    }
                };
