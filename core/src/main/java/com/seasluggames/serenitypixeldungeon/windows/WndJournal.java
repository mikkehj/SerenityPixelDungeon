...
import com.seasluggames.serenitypixeldungeon.items.armor.ClassArmor;
...
import com.seasluggames.serenitypixeldungeon.ui.QuickRecipe;
...
public class WndJournal extends WndTabbed {
	...
	public static class AlchemyTab extends Component {
		...
		private PurpleButton[] pageButtons;
		...
		@Override
		protected void createChildren() {
			pageButtons = new PurpleButton[NUM_BUTTONS];
			for (int i = 0; i < NUM_BUTTONS; i++){
				final int idx = i;
				pageButtons[i] = new PurpleButton( "" ){
					@Override
	...
	private static class CatalogTab extends Component{
		...
		private PurpleButton[] itemButtons;
		...
		@Override
		protected void createChildren() {
			itemButtons = new PurpleButton[NUM_BUTTONS];
			for (int i = 0; i < NUM_BUTTONS; i++){
				final int idx = i;
				itemButtons[i] = new PurpleButton( "" ){
					@Override
					protected void onClick() {
						currentItemIdx = idx;
						updateList();
